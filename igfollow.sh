C #!/bin/bash 
 # Inshackle v1.0 
 # recoded by: the developer😡
 # github.com/thedeveloper03 inshackle-bot 
 ...
 printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by the developer😡\e[0m\n" 
 } 
